...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'fs_news_defaults_370ee7320a0d82916451_20201015072739_archive.zip';
	const ARCHIVE_SIZE		 = '45666066';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '370ee73-15072739';
    const SECONDARY_PACKAGE_HASH = 'f1314ac-15072739';
